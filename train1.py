...
def Train(directory, epochs, n_classes, in_size, out_dim, dropout, slope, lr, wd, random_seed, cuda):
    ...
    g, disease_vertices, mirna_vertices, ID, IM, samples ,ID1, IM1= build_graph(directory, random_seed)
    ...
    adj_m = torch.FloatTensor(adj_max)
    ...
    adj_q = edge_index_to_sparse_mx(transposed_list, 878)
